...
<html>
    ...
    <body><!--#########################################################################################################-->                       
			    ...
			    <table class="navbar" sytle="border:5px solid #fff">
				    <tr>				
                        ...
                        <td align="center" width="70%" class="auto-style1">
						    <a href="MapaCliente.aspx"><img class="logomge" src="/Images/google_maps_borda.png" height="70px"></a>
					    </td>
        ...
        <form runat="server" class="auto-style5" />
            <a href="Login.aspx"><asp:Image ID="Image1" runat="server" ImageAlign="Right" ImageUrl="/Images/botao_voltar.png" /></a>
