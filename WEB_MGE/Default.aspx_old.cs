...
namespace WEB_MGE
{
    public partial class Default1 : System.Web.UI.Page
    {
        ...
        {
            if(Variaveis_Globais.PerfilUsuario == "ADMIN2")
            {
                Variaveis_Globais.Url = "MapaSelecao.aspx";
            }
            else
            {
                Variaveis_Globais.Url = "MapaCliente.aspx";
            }
            HyperLink1.NavigateUrl = Variaveis_Globais.Url;
